...
void TeacherWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onSetGradeClicked(); break;
        case 3: _t->onLogoutClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TeacherWindow::*)()>(_a, &TeacherWindow::logoutRequested, 0))
            return;
    }
}
...
// SIGNAL 0
void TeacherWindow::logoutRequested()
{
